...
HD_PWD='D:/New folder/vivado_proj/project_4_oled/project_4_oled.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_basys3_oled_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_basys3_oled_adder.tcl
