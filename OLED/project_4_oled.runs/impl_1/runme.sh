...
HD_PWD='D:/New folder/vivado_proj/project_4_oled/project_4_oled.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_basys3_oled_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_basys3_oled_adder.tcl -notrace
