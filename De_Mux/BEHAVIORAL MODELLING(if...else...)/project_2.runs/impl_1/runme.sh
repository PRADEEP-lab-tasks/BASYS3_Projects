...
HD_PWD='E:/VIVADO PROJECTs/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demux_1_to_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demux_1_to_4.tcl -notrace
