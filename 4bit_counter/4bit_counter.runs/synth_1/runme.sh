...
HD_PWD='D:/4bit_counter/4bit_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrappper_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrappper_out.tcl
