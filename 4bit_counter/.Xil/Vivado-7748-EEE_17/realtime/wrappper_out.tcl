...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "D:/Aaalalm/analog/4bit_counter/.Xil/Vivado-7748-EEE_17/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog {
      D:/Aaalalm/analog/4bit_counter/4bit_counter.srcs/sources_1/new/counter.v
      D:/Aaalalm/analog/4bit_counter/4bit_counter.srcs/sources_1/new/oneHz_gen.v
      D:/Aaalalm/analog/4bit_counter/4bit_counter.srcs/sources_1/new/wrappper_out.v
    }
      rt::filesetChecksum
    }
    rt::set_parameter usePostFindUniquification false
    set rt::top wrappper_out
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "D:/Aaalalm/analog/4bit_counter/.Xil/Vivado-7748-EEE_17/"
